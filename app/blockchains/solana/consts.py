...
# This is the program for secondary market
DIGITAL_EYES_NFT_MARKETPLACE_PROGRAM_ACCOUNT = "A7p8451ktDCHq5yYaHczeLMYsjRsAkzc3hCXcSrwYHU7"
DIGITAL_EYES_DIRECT_SELL_PROGRAM_ACCOUNT = "7t8zVJtPCFAqog1DcnB6Ku1AVKtWfHkCiPi1cAvcJyVF"
...
SOLANA_MONKEY_BUSINESS_PROGRAM_ACCOUNT_V2 = 'J7RagMKwSD5zJSbRQZU56ypHUtux8LRDkUpAPSKH4WPp'
SOLANA_MONKEY_BUSINESS_PROGRAM_ACCOUNT_V3 = '5ZfZAwP2m93waazg8DkrrVmsupeiPEvaEHowiUP7UAbJ'

SOLANA_OPEN_SEA_PROGRAM_ACCOUNT = 'M2mx93ekt1fmXSVkTrUL9xVFHkmME8HTUi5Cyc5aF7K'
SOLANA_OPEN_SEA_AUCTION_PROGRAM_ACCOUNT = 'hausS13jsjafwWwGqZTUQRmWyvyxn9EQpqMwV1PBBmk'

SOLANA_EXCHANGE_ART_PROGRAM_ACCOUNT = 'AmK5g2XcyptVLCFESBCJqoSfwV3znGoVYQnqEnaAZKWn'
SOLANA_EXCHANGE_ART_PROGRAM_ACCOUNT_V2 = 'exofLDXJoFji4Qyf9jSAH59J4pp82UT5pmGgR6iT24Z'
SOLANA_EXCHANGE_ART_AUCTION_PROGRAM_ACCOUNT = 'exAuvFHqXXbiLrM4ce9m1icwuSyXytRnfBkajukDFuB'

MARKET_NAME_MAP = {
    SOLANA_MAGIC_EDEN: "MagicEden",
    SOLANA_ALPHA_ART: "AlphaArt",
    SOLANA_SOLANART: "Solanart",
    SOLANA_DIGITAL_EYES: "DigitalEyes",
    SOLANA_SOLSEA: "Solsea",
    SOLANA_SMB: 'Solana Monkey Business',
    SOLANA_OPEN_SEA: 'OpenSea',
    SOLANA_EXCHANGE_ART: 'ExchangeArt',
}
...
MARKET_ADDRESS_MAP = {
    ...
    SOLANA_OPEN_SEA: SOLANA_OPEN_SEA_PROGRAM_ACCOUNT,
    SOLANA_EXCHANGE_ART: SOLANA_EXCHANGE_ART_PROGRAM_ACCOUNT
}

MARKET_PROGRAM_ID_MAP = {
    MAGIC_EDEN_PROGRAM_ACCOUNT: SOLANA_MAGIC_EDEN,
    MAGIC_EDEN_PROGRAM_ACCOUNT_V2: SOLANA_MAGIC_EDEN,
    MAGIC_EDEN_AUCTION_PROGRAM_ACCOUNT: SOLANA_MAGIC_EDEN,
    ALPHA_ART_PROGRAM_ACCOUNT: SOLANA_ALPHA_ART,
    DIGITAL_EYES_DIRECT_SELL_PROGRAM_ACCOUNT: SOLANA_DIGITAL_EYES,
    DIGITAL_EYES_NFT_MARKETPLACE_PROGRAM_ACCOUNT: SOLANA_DIGITAL_EYES,
    ...
    SOLANA_MONKEY_BUSINESS_PROGRAM_ACCOUNT_V2: SOLANA_SMB,
    SOLANA_MONKEY_BUSINESS_PROGRAM_ACCOUNT_V3: SOLANA_SMB,
    SOLANA_OPEN_SEA_PROGRAM_ACCOUNT: SOLANA_OPEN_SEA,
    SOLANA_OPEN_SEA_AUCTION_PROGRAM_ACCOUNT: SOLANA_OPEN_SEA,
    SOLANA_EXCHANGE_ART_PROGRAM_ACCOUNT: SOLANA_EXCHANGE_ART,
    SOLANA_EXCHANGE_ART_PROGRAM_ACCOUNT_V2: SOLANA_EXCHANGE_ART,
    SOLANA_EXCHANGE_ART_AUCTION_PROGRAM_ACCOUNT: SOLANA_EXCHANGE_ART,
}
