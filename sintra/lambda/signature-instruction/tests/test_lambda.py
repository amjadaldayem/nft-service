...
class TestLambdaFunction:
    @patch("src.app.solana_client.get_transaction")
    def test_lambda_handler(
        self,
        solana_client_get_transaction_fn,
        kinesis_secondary_market_stream,
        kinesis_input_event: Dict[str, Any],
    ) -> None:
        solana_client_get_transaction_fn.return_value = transaction_example()
    ...
    def test_lambda_handler_when_invalid_transaction(
        ...
        solana_client_get_transaction_fn.return_value = invalid_transaction_example()
